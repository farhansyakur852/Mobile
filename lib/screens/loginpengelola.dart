...
class LoginPengelolaScreen extends StatefulWidget{
  const LoginPengelolaScreen  ({Key? key}) : super(key: key);

  @override
  State<LoginPengelolaScreen> createState () => _LoginPengelolaScreenState(); 
}

class _LoginPengelolaScreenState extends State<LoginPengelolaScreen>{
  @override
      ...
      body: Stack(
            ...
            Text(
              ...
              SizedBox(height: 100,),
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(context, rHalamanAdmin);
                  },
                  ...
                  child: const Text('Login Pengelola'),
                ),
