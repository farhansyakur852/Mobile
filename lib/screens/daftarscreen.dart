...
class LoginDaftarScreen extends StatefulWidget{
  const LoginDaftarScreen  ({Key? key}) : super(key: key);

  @override
  State<LoginDaftarScreen> createState () => _LoginDaftarScreenState(); 
}

class _LoginDaftarScreenState extends State<LoginDaftarScreen>{
  @override
